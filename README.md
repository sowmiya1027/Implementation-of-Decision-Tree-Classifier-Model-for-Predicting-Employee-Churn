...
## Algorithm
```
1.Load the employee dataset, preprocess the data, and encode categorical variables using dummy encoding.
2. Define the feature variables (X) and target variable (y), then split the dataset into training and testing sets.
3. Create and train the DecisionTreeClassifier model using the training data and make predictions on the test data.
4. Evaluate the model using confusion matrix, accuracy score, and classification report, and visualize the decision tree using plot_tree(). 
```
...
<img width="1268" height="512" alt="image" src="https://github.com/user-attachments/assets/6461ec9a-3211-4670-9fd7-92baa9a7add2" />
<img width="1175" height="605" alt="image" src="https://github.com/user-attachments/assets/cfeaed10-b22a-45b5-ae19-d6a09972512a" />
